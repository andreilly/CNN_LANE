...
def main():
    ...
    neural_net.fit_generator(augmentor.flow(X_train, y_train, batch_size=b_size), steps_per_epoch=math.ceil(len(X_trainlen(X_train)/b_size), epochs=n_epochs, verbose=1, validation_data=(X_val, y_val))
